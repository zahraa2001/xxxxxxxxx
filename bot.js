...
client.on('ready', () => {
   console.log(`----------------`);
      console.log(`Cyhper Script By : MISTEAX`);
        console.log(`----------------`);
      console.log(`ON ${client.guilds.size} Servers '     Script By : Misteax ' `);
    console.log(`----------------`);
...
client.login(NjQ3MzI4MzYyODgwMzAzMTA1.XdeFiw.I98487D8pLHPc9PbtRDhu2d--SY);
// لا تغير فيها شيء